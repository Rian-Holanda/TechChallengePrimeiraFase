...
namespace UnitTest_TechChallengePrimeiraFase
{
    public class UnitTest1
    {
        ...
        public void Test1()
        {
            var data = _context.ContatosPessoas.ToList();


            RegioesEntity regioesEntity = new RegioesEntity();

            regioesEntity.Sigla = "SP";
         

            var result = _context.Regioes.Add(regioesEntity);

             RegiaoCommand regiaoCommand = new RegiaoCommand(_context);

            regiaoCommand.InserirRegiao(regioesEntity);
